...
public class Bookstores extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.bookstores, container,
                false);
        
        progressDialog = ProgressDialog.show( getActivity(), "", "Loading", true );
        listView = (ListView) rootView.findViewById( R.id.bookstores );
        
        getBookstoresTasks( new BackendlessCallback<BackendlessCollection<ActionCreation>>()
        	    {
        	      @Override
	...
	public static void getBookstoresTasks( final AsyncCallback<BackendlessCollection<ActionCreation>> responder )
	  {
		String whereClause = "category = ' нижные магазины'";
