...
public class Appliances extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.appliances, container,
                false);
        
        progressDialog = ProgressDialog.show( getActivity(), "", "Loading", true );
        listView = (ListView) rootView.findViewById( R.id.appliances );
        
        getAppliancesTasks( new BackendlessCallback<BackendlessCollection<ActionCreation>>()
        	    {
        	      @Override
	...
	public static void getAppliancesTasks( final AsyncCallback<BackendlessCollection<ActionCreation>> responder )
	  {
		String whereClause = "category = 'Бытовая техника'";
