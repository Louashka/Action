	...
	ArrayList<AllCategoriesItems> userActionsList = new ArrayList<AllCategoriesItems>();
	 ...
	 public Resturants() {
	    ...
	    public View onCreateView(LayoutInflater inflater, ViewGroup container,
	        ...
	        View rootView = inflater.inflate(R.layout.resturants, container,
	                false);
	        
	        progressDialog = ProgressDialog.show( getActivity(), "", "Loading", true );
	        listView = (ListView) rootView.findViewById( R.id.resturants );
	        
	        getResturantsTasks( new BackendlessCallback<BackendlessCollection<ActionCreation>>()
	        	    {
	        	      @Override
		...
		public static void getResturantsTasks( final AsyncCallback<BackendlessCollection<ActionCreation>> responder )
		  {
			String whereClause = "category = 'Кафе/Рестораны'";
