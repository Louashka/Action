...
public class Clothes extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.clothes, container,
                false);
        
        progressDialog = ProgressDialog.show( getActivity(), "", "Loading", true );
        listView = (ListView) rootView.findViewById( R.id.clothes );
        
        getClothesTasks( new BackendlessCallback<BackendlessCollection<ActionCreation>>()
        	    {
        	      @Override
	...
	public static void getClothesTasks( final AsyncCallback<BackendlessCollection<ActionCreation>> responder )
	  {
		String whereClause = "category = 'ќдежда'";
